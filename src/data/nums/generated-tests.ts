...
export const numsTest1: NUMSQuestion[] = [
  {
    "id": "testmoz-bio-5",
  ...
  {
    "id": "testmoz-bio-35",
    "question": "The excretory system of flatworms is composed of",
    "options": [
      "Nephron",
      "Flame cells",
      "Nephridia",
  ...
  {
    "id": "testmoz-bio-30",
    "question": "Students were asked to give a guess about a unicellular organism with darkly stained nucleus which of the following can be straight away exclude from the list",
    "options": [
      "Paramecium",
      "Amoeba",
      "Plasmodium",
  ...
  {
    "id": "enzymes-006",
    "question": "Reversible Inhibitors differ from Irreversible Inhibitors because they:",
    "options": [
  ...
  {
    "id": "biomolecules-033",
    "question": "Which of the following biological molecules releases highest energy from its own gram?",
    "options": [
      "Carbohydrates",
      "Lipids",
      "Protein",
  ...
  {
    "id": "testmoz-bio-29",
    "question": "Which of the following stage of metamorphosis resembles to its mother",
    "options": [
      "Egg",
      "Nymph",
      "Tadpole",
  ...
  },
  {
    ...
    "question": "Which one of the following types of phosphorylation occurs in electron transport chain, when NADH transfers electrons to coenzyme Q in inner mitochondrial membrane?",
    "options": [
  ...
  },
  {
    ...
    "question": "In the following process, the cells release energy from oxidation of food molecules:",
    "options": [
  ...
  {
    "id": "testmoz-bio-31",
    "question": "Select an anamniotic from the following",
    "options": [
      "Snake",
      "Parrot",
      "Frog",
  ...
  {
    "id": "enzymes-005",
    "question": "According to Lock and Key model, the active site is regarded as:",
    "options": [
      "Rigid and specific",
  ...
  {
    "id": "testmoz-bio-20",
    "question": "It provides protection of coastline from storm, shelter from marine organism, assist in carbon & nitrogen fixing",
    "options": [
      "Coral reefs",
      "Polyps",
      "Mollusca",
  ...
  {
    "id": "testmoz-bio-37",
    "question": "Following are the various names of nucleoid except",
    "options": [
      "Nuclear body",
      "Chromatin body",
      "Nuclear region",
  ...
  {
    "id": "testmoz-bio-17",
    "question": "........ also called liver fluke",
    "options": [
      "Dugesia",
      "Fasciola",
      "Taenia",
  ...
  {
    "id": "testmoz-bio-9",
    "question": "The animals in which body can be divided in to two equal halves in one plane only, are called",
    "options": [
      "Asymmetrical",
      "Radial",
      "Bilateral",
...
export const numsTest2: NUMSQuestion[] = [
  {
    "id": "enzymes-018",
  ...
  {
    "id": "testmoz-bio-32",
    "question": "Heat sensitive compounds like antibiotics seras and hormones can be sterilized by means of",
    "options": [
      "Radiations",
      "Chemicals",
      "Membrane filters",
  ...
  {
    "id": "testmoz-bio-43",
    "question": "Moist heat cause ........ and kill the microbes",
    "options": [
      "Oxidation of proteins",
      "Conjugation of proteins",
      "Degeneration of nucleic acids",
      "Bursting up of cells"
    ],
    "answer": 1
  },
  {
  ...
  {
    "id": "testmoz-bio-48",
    "question": "Which one of the following antibiotics cause permanent discoloration of teeth in young children if it is Miss used",
    "options": [
      "Penicillin",
      "Streptomycin",
      "Sulphonamide",
  ...
  {
    "id": "testmoz-bio-1",
    "question": "The pores by which the water leaves the body of sponges are called",
    "options": [
      "Ostia",
      "Anus",
      "Mouth",
  ...
  },
  {
    ...
    "options": [
      "Gram Positive Bacteria have more lipids in their cell wall",
      "Gram Negative bacteria have more lipids in their cell wall",
      "Lipids are present in cell wall of both gram positive and Gram Negative bacteria",
      "Both have equal amount of lipids"
    ],
    "answer": 1
  },
  {
...
export const numsTest3: NUMSQuestion[] = [
  {
    "id": "testmoz-bio-18",
    "question": "The layer which forms the linking of digestive tract and glands of digestive system",
    "options": [
      "Ectoderm",
      "Endoderm",
      "Mesoderm",
  ...
  {
    "id": "biomolecules-036",
    "question": "The complementary base pairing in DNA is important because it:",
    "options": [
  ...
  {
    "id": "testmoz-bio-33",
    "question": "Marsupium is a characteristic feature of",
    "options": [
      "Opossum",
      "Dolphin",
      "Echidna",
  ...
  {
    "id": "testmoz-bio-7",
    "question": "Arrangement of focus bacteria in chain is called",
    "options": [
      "Streptococci",
      "Staphylococci",
      "Tetrad",
  ...
  {
    "id": "testmoz-bio-10",
    "question": "Which one of the following is the primary host of liver fluke",
    "options": [
      "Man",
      "Sheep",
      "Snail",
  ...
  {
    "id": "bio-cell-032",
    "question": "In humans, how many kinds of tRNA are present for the synthesis of proteins?",
    "options": [
      "40",
      "45",
      "43",
  ...
  {
    "id": "circulation-007",
    "question": "The bony roof of the oral cavity, which separates it from the nasal cavity, is formed by the:",
    "options": [
      "Soft palate",
      "Mandible",
      "Hard palate",
  ...
  {
    "id": "testmoz-bio-36",
    "question": "The animal with exceptionally large brain is",
    "options": [
      "Star fish",
      "Snail",
      "Octopus",
  ...
  {
    "id": "testmoz-bio-9",
    "question": "Maintaining the microbial population at constant level is called",
    "options": [
      "Microbiostatic approach",
  ...
  {
    "id": "testmoz-bio-49",
    "question": "What is an invagination cell membrane which help in cell division",
    "options": [
      "Mesosomes",
      "Pilli",
      "Flagella",
  ...
  {
    "id": "biomolecules-034",
    "question": "A food sample contains long chains of amino acids bounded together. This indicates the presence of:",
    "options": [
      "Carbohydrates",
      "Lipids",
      "Proteins",
  ...
  {
    "id": "bio-cell-013",
    "question": "An active athlete has more stamina for running compared to an officer of the same age with a physically inactive lifestyle. Which of the following organelles has greatly increased in the muscle cells of the athlete?",
    "options": [
      "Nucleus",
      "Mitochondria",
      "Golgi bodies",
  ...
  {
    "id": "circulation-022",
    "question": "Which of the following blood groups has anti-A and anti-B antibodies in the serum?",
    "options": [
      "A",
      "AB",
      "B",
  ...
  {
    "id": "nums-test-3-52",
    "question": "A modified virus that infects birds only belongs to which category?",
    "options": [
      "Algal virus",
      "Fungal virus",
      "Animal virus",
  ...
  {
    "id": "testmoz-bio-46",
    "question": "Skeleton of marine shelled sarcodians give clue due to possible deposit of",
    "options": [
      "Potassium",
      "Petroleum",
      "Magnesium",
  ...
  {
    "id": "testmoz-bio-4",
    "question": "It is universally accepted by biologists that mammals have evolved from ancestors called",
    "options": [
      "Cotylosaurs",
      "Cyclostomata",
      "Dianosaurs",
