...
title: "Letter Series",
description:
"Identify patterns, sequences and relationships between letters",
videoId: "zgapXXJwe8k",
},
{
id: 2,
title: "Letter Series 2",
description:
"Identify patterns, sequences and relationships between letters",
videoId: "fURmU-9G3wU",
},
...
{
id: 6,
title: "Symbol Series & Patterns",
description:
"Solve symbol-based sequences and identify changing patterns",
videoId: "eV9Id-UZiPw",
},
];

export default function LetterAndSymbolSeriesPage() {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-300">
            Identify patterns and relationships in letters and symbols
          </p>
        </div>
      </div>
    </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">
                Look for the rule behind a sequence instead of guessing
                the next item. Check changes in position, alphabetical
                order, repetition and intervals carefully.
              </p>
            </div>
          </div>
        </div>
