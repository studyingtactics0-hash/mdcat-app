...
{
id: 1,
title: "Basics of Logical Deductions",
description:
"Learn how to derive conclusions from statements using logical reasoning",
videoId: "5J1w5DjrlDo",
},
{
id: 2,
title: "Solving Deduction Problems",
description:
"Apply deduction techniques to solve MDCAT-style logical reasoning questions",
videoId: "dDkTd_s67DE",
},
];

export default function LogicalDeductionsPage() {
...
```
      <div className="flex items-center gap-4">
        <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-yellow-100 text-3xl">
          💡
        </div>

        <div>
          <p className="text-sm font-medium text-yellow-400">
            LOGICAL REASONING • CHAPTER 03
          </p>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">
                Read every statement carefully before drawing a
                conclusion. Base your answer only on the information
                provided and avoid adding assumptions that are not given.
              </p>
            </div>
          </div>
        </div>
      ...
      <aside className="h-fit lg:sticky lg:top-6">
        <div className="overflow-hidden rounded-2xl bg-white shadow-sm">
          <div className="bg-[#0b1e39] p-5 text-white">
            <p className="text-xs font-semibold tracking-wider text-yellow-400">
              LOGICAL REASONING • CHAPTER 03
            </p>
