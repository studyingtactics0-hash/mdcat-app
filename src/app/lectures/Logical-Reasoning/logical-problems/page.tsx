...
{
id: 1,
title: "Understanding Logical Problems",
description:
"Learn how to break down complex logical problems into manageable steps",
videoId: "uUEXZNAZjJo",
},
{
id: 2,
title: "Solving Logical Problems",
description:
"Use systematic reasoning and elimination techniques to solve problems",
videoId: "JEc_MmSmups",
},
];

export default function LogicalProblemsPage() {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-300">
            Solve complex problems using reasoning and deduction
          </p>
        </div>
      </div>
    </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">
                Break every problem into smaller pieces. Write down the
                information given, identify what is being asked and
                eliminate options that contradict the conditions.
              </p>
            </div>
          </div>
        </div>
