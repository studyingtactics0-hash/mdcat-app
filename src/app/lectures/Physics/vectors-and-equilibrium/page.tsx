...
const lectures = [
  {
    number: 1,
    title: "Vectors and Equilibrium — Lecture 1",
    shortTitle: "Introduction to Vectors",
    description:
      "Introduction to vectors, vector quantities, representation of vectors and basic concepts.",
    videoId: "pMCvfvppYgM",
  },
  {
    number: 2,
    title: "Vectors and Equilibrium — Lecture 2",
    shortTitle: "Components of Vectors",
    description:
      "Resolution of vectors, rectangular components and applications of vector components.",
    videoId: "AOT7pRxajcU",
  },
  {
    number: 3,
    title: "Vectors and Equilibrium — Lecture 3",
    shortTitle: "Moments & Equilibrium",
    description:
      "Moments, torque and the conditions required for a body to remain in equilibrium.",
    videoId: "SjofZweFfKA",
  },
];

export default function VectorsAndEquilibriumPage() {
      ...
      <header className="bg-[#0b1e39] text-white shadow-lg">
        <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-purple-100 text-3xl shadow-sm">
              🧭
            </div>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-slate-300">
                Vectors, components, moments and conditions of equilibrium
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    Watch the lecture carefully, make short notes and then
                    practice MCQs from this chapter to strengthen your
                    concepts.
                  </p>
                </div>
              </div>
          ...
          <aside className="h-fit overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm lg:sticky lg:top-6">
            ...
            <div className="bg-[#0b1e39] p-5 text-white">
              ...
              <div className="mt-4 flex items-center justify-between text-xs text-slate-300">
                ...
                <span>
                  {selectedLecture + 1} of {lectures.length} selected
                </span>
              </div>
