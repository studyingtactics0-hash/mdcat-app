...
const lectures = [
  {
    number: 1,
    title: "Force and Motion — Lecture 1",
    shortTitle: "Introduction to Force & Motion",
    description:
      "Introduction to force and motion, basic concepts, reference frames and types of motion.",
    videoId: "O54MTrXBAME",
  },
  {
    number: 2,
    title: "Force and Motion — Lecture 2",
    shortTitle: "Displacement, Velocity & Speed",
    description:
      "Understanding displacement, distance, speed, velocity and their relationships.",
    videoId: "CA3JYs9kJfU",
  },
  {
    number: 3,
    title: "Force and Motion — Lecture 3",
    shortTitle: "Acceleration",
    description:
      "Acceleration, uniform and non-uniform motion and interpretation of motion.",
    videoId: "B2jZU1R_oO4",
  },
  {
    number: 4,
    title: "Force and Motion — Lecture 4",
    shortTitle: "Equations of Motion",
    description:
      "Derivation and application of the equations of uniformly accelerated motion.",
    videoId: "je0irHLX3d4",
  },
  {
    number: 5,
    title: "Force and Motion — Lecture 5",
    shortTitle: "Newton's Laws of Motion",
    description:
      "Newton's three laws of motion and their applications to real-world problems.",
    videoId: "7YGfT-YmFB4",
  },
  {
    number: 6,
    title: "Force and Motion — Lecture 6",
    shortTitle: "Momentum & Impulse",
    description:
      "Linear momentum, impulse and the relationship between force and change in momentum.",
    videoId: "rZVFpmQpy08",
  },
  {
    number: 7,
    title: "Force and Motion — Lecture 7",
    shortTitle: "Conservation of Momentum",
    description:
      "The principle of conservation of momentum and its applications.",
    videoId: "ju1HKdJXp_A",
  },
  {
    number: 8,
    title: "Force and Motion — Lecture 8",
    shortTitle: "Friction",
    description:
      "Static and kinetic friction, coefficient of friction and applications.",
    videoId: "Vok_pNG81yM",
  },
  {
    number: 9,
    title: "Force and Motion — Lecture 9",
    shortTitle: "Projectile Motion",
    description:
      "Projectile motion, horizontal and vertical components and important equations.",
    videoId: "62qLde84T9I",
  },
  {
    number: 10,
    title: "Force and Motion — Lecture 10",
    shortTitle: "Force & Motion — Revision",
    description:
      "Complete chapter revision with important concepts, formulas and MDCAT-focused questions.",
    videoId: "Tun1GgGNx2o",
  },
];
      ...
      <header className="bg-[#0b1e39] text-white shadow-lg">
        <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-blue-100 text-3xl shadow-sm">
              ⚡
            </div>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-slate-300">
                Force, motion, Newton's laws, momentum and applications
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    Focus on understanding the concepts and formulas rather
                    than memorizing them. After completing the lectures,
                    practice MDCAT-style MCQs from this chapter.
                  </p>
                </div>
              </div>
            </div>
