...
const lectures = [
  {
    id: 1,
    title: "Matter & Its Classification",
    description:
      "Matter, elements, compounds, mixtures and physical states of matter",
    videoId: "aI4bhAxqpHM",
  },
  {
    id: 2,
    ...
    description:
      "Protons, neutrons, electrons, atomic number, mass number and isotopes",
    videoId: "lTcRUsM5Yyg",
  },
  {
    id: 3,
    title: "Molecules, Ions & Chemical Formulae",
    description:
      "Molecules, ions, valency, chemical formulae and basic chemical notation",
    videoId: "dAjVKVlZVm8",
  },
  {
    id: 4,
    title: "Mole Concept & Basic Calculations",
    description:
      "Moles, Avogadro's number, molar mass and fundamental numerical problems",
    videoId: "JG-VAPrGYmE",
  },
];

export default function FundamentalConceptsChemistryPage() {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-300">
                Basic concepts, atomic structure, chemical formulae and mole
                concept
              </p>
            </div>
          </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    Build a strong foundation before moving to advanced
                    Chemistry chapters. Pay special attention to atomic
                    structure, chemical formulae, valency and mole
                    calculations because these concepts are used throughout
                    Chemistry.
                  </p>
                </div>
              </div>
