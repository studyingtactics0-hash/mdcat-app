...
const lectures = [
  {
    ...
    description:
      "Understand conditional sentences, their different types, and how to use the correct verb forms to express conditions and their results",
    videoId: "s7ltKXjSyYY",
  },
];

export default function ConditionalSentencesPage() {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-300">
                Learn how to use conditional sentences correctly
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-gray-700">
                    Focus on the relationship between the condition and its
                    result. Learn the structures of zero, first, second, and
                    third conditionals, and pay close attention to the tense
                    used in each part of the sentence.
                  </p>
                </div>
              </div>
            </div>
