...
const lectures = [
  {
    ...
    title: "Helping Verbs",
    description:
      "Understand helping verbs, their types and how they work with main verbs to form correct sentences",
    videoId: "YOUR_VIDEO_ID_1",
  },
];

export default function HelpingVerbsPage() {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-300">
                Understand helping verbs and their role in sentence formation
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    Remember that helping verbs work together with the main
                    verb to express tense, mood, voice or other meanings.
                    Common helping verbs include forms of
                    <span className="font-semibold"> be, have, and do</span>,
                    as well as modal verbs such as
