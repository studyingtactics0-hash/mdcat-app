...
const lectures = [
  {
    ...
    description:
      "Understand the rules of subject-verb agreement and learn how to use the correct verb with singular and plural subjects",
    videoId: "WtYJ9ZQGvxs",
  },
];
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-300">
                Master subject-verb agreement and use correct verb forms
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-gray-700">
                    Always identify the main subject before choosing the
                    verb. Singular subjects generally take singular verbs,
                    while plural subjects take plural verbs. Pay special
                    attention to words between the subject and verb, as well
                    as compound subjects and indefinite pronouns.
                  </p>
                </div>
              </div>
            </div>
