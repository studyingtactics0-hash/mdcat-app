...
const chapters = [
  {
    ...
    emoji: "📖",
    description: "Understand passages, identify key ideas and answer comprehension questions",
    lectures: 3,
  ...
  },
  {
    ...
    name: "Pronoun",
    emoji: "📝",
    description: "Demo chapter — content will be updated later",
    lectures: 3,
  ...
  },
  {
    ...
    name: "Helping Verb",
    emoji: "💡",
    description: "Also known as Auxiliary verb or Linking Verb",
    lectures: 1,
...
export default function EnglishLecturesPage() {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-gray-300">
            Improve your English language skills and prepare effectively for MDCAT
          </p>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {chapters.map((chapter) => (
            ...
            >
              ...
              >
                <span>View {chapter.lectures} Lectures</span>
        ...
        <div className="mt-12 pb-6 text-center">
          ...
          <p className="text-sm text-gray-500">
            📖 Read • Understand • Practice • Succeed
          </p>
