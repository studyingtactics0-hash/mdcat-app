...
const lectures = [
  {
    ...
    title: "Prepositions",
    description:
      "Understand prepositions, their types, and how to use them correctly to show relationships between words in a sentence",
    videoId: "quFBVng131g",
  },
];
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-300">
                Learn how to use prepositions correctly in sentences
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-gray-700">
                    Pay close attention to commonly confused prepositions
                    such as in, on, and at. Learn which preposition normally
                    follows a particular verb, adjective, or expression, and
                    always consider the context of the sentence when choosing
