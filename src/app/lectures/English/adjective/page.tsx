...
const lectures = [
  {
    ...
    title: "Adjectives",
    description:
      "Learn how adjectives describe nouns and pronouns, their types, and how to use them correctly in sentences",
    videoId: "MBUo8hsUc8s",
  },
];
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-300">
                Describe nouns and pronouns accurately using adjectives
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    When identifying an adjective, ask yourself which word
                    describes or gives more information about a noun or
                    pronoun. Also remember that adjectives can describe
                    qualities, quantities, numbers, or ownership.
                  </p>
                </div>
              </div>
            </div>
