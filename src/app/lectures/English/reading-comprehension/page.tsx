...
const lectures = [
  {
    ...
    description:
      "Learn how to read passages effectively, identify the main idea and understand important details",
    videoId: "bFfDN46VXrQ",
  },
  {
    id: 2,
    title: "Analyzing Reading Comprehension Passages",
    description:
      "Develop strategies to analyze passages, identify key information and understand the author's message",
    videoId: "kHky3Tapg20",
  },
  {
    id: 3,
    title: "Solving Reading Comprehension Questions",
    description:
      "Practice answering comprehension questions using evidence from the passage and effective elimination techniques",
    videoId: "GWJtOHsyWOY",
  },
];
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-300">
                Understand passages and answer comprehension questions effectively
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    ...
                    Focus on the main idea, supporting details and the exact
                    information given in the passage. Avoid choosing an answer
                    simply because it sounds correct — always look for evidence
                    in the text.
                  </p>
                </div>
              </div>
