export default function ForceAndMotionPage() {
    const tests = [
      {
        title: "Force and Motion — Test 1",
        questions: 20,
        time: 20,
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/force-and-motion/test-1",
      },
      {
        title: "Force and Motion — Test 2",
        questions: 35,
        time: 35,
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/force-and-motion/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/force-and-motion/test-3",
      },
      {
        title: "Force and Motion — Test 4",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/force-and-motion/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/force-and-motion/test-5",
      },
    ];
