    ...
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/waves/test-1",
      },
      {
        title: "Waves — Test 2",
        questions: 35,
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/waves/test-2",
      },
      {
        title: "Waves — Test 3",
        questions: 50,
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/waves/test-3",
      },
      {
        title: "Waves — Test 4",
        questions: 50,
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/waves/test-4",
      },
      {
        title: "Waves — Test 5",
        questions: 50,
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/waves/test-5",
      },
    ];
