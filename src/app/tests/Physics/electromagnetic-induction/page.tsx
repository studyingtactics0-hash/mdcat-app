    ...
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/electromagnetic-induction/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/electromagnetic-induction/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/electromagnetic-induction/test-3",
      },
      {
        title: "Electromagnetic Induction — Test 4",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/electromagnetic-induction/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/electromagnetic-induction/test-5",
      },
    ];
