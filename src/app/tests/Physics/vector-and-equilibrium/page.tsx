    ...
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/vector-and-equilibrium/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/vector-and-equilibrium/test-2",
      },
      {
        title: "Vectors and Equilibrium — Test 3",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/vector-and-equilibrium/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/vector-and-equilibrium/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/vector-and-equilibrium/test-5",
      },
    ];
