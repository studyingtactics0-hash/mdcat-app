export default function DawnOfModernPhysicsPage() {
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/dawn-of-modern-physics/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/dawn-of-modern-physics/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/dawn-of-modern-physics/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/dawn-of-modern-physics/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/dawn-of-modern-physics/test-5",
      },
    ];
