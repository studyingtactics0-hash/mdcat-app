export default function AlternatingCurrentPage() {
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/alternating-current/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/alternating-current/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/alternating-current/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/alternating-current/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/alternating-current/test-5",
      },
    ];
