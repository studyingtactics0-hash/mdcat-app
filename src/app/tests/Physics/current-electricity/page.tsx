    ...
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/current-electricity/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/current-electricity/test-2",
      },
      {
        title: "Current Electricity — Test 3",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/current-electricity/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/current-electricity/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/current-electricity/test-5",
      },
    ];
