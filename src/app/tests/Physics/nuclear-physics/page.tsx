    ...
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/nuclear-physics/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/nuclear-physics/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/nuclear-physics/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/nuclear-physics/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/nuclear-physics/test-5",
      },
    ];
