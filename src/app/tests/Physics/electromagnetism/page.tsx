    ...
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/electromagnetism/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/electromagnetism/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/electromagnetism/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/electromagnetism/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/electromagnetism/test-5",
      },
    ];
