    ...
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/rotational-and-circular-motion/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/rotational-and-circular-motion/test-2",
      },
      {
        title: "Rotational and Circular Motion — Test 3",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/rotational-and-circular-motion/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/rotational-and-circular-motion/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/rotational-and-circular-motion/test-5",
      },
    ];
