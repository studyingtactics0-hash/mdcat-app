export default function WorkAndEnergyPage() {
    const tests = [
      {
        title: "Work and Energy — Test 1",
        questions: 20,
        time: 20,
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/work-and-energy/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/work-and-energy/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/work-and-energy/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/work-and-energy/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/work-and-energy/test-5",
      },
    ];
