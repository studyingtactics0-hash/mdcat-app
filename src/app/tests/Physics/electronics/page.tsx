    ...
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/Physics/electronics/test-1",
      },
      {
        title: "Electronics — Test 2",
        questions: 35,
        time: 35,
        difficulty: "Moderate",
        available: true,
        link: "/tests/Physics/electronics/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/electronics/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/electronics/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/Physics/electronics/test-5",
      },
    ];
