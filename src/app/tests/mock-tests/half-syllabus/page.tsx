...
export default function HalfSyllabusMockTestsPage() {
  ...
  const mockTests = [
    {
      id: 1,
      title: "Half-Syllabus 1st year Mock Test 1",
      questions: 180,
      time: 180,
      difficulty: "MDCAT",
    },
    {
      id: 2,
      title: "Half-Syllabus 2nd year Mock Test 1",
      questions: 180,
      time: 180,
      difficulty: "MDCAT",
    },
    {
      id: 3,
      title: "Half-Syllabus 1st year Mock Test 2",
      questions: 180,
      time: 180,
      difficulty: "MDCAT",
    },
    {
      id: 4,
      title: "Half-Syllabus 2nd year Mock Test 2",
      questions: 180,
      time: 180,
      difficulty: "MDCAT",
    },
    {
      id: 5,
      title: "Half-Syllabus 1st year Mock Test 3",
      questions: 180,
      time: 180,
      difficulty: "MDCAT",
    },
    {
      id: 6,
      title: "Half-Syllabus 2nd year Mock Test 3",
      questions: 180,
      time: 180,
      difficulty: "MDCAT",
    },
