...
import { readingAndThinkingSkillPassages } from "@/data/mock tests/half-syllabus/1st-year";
...
} from "@/data/mock tests/half-syllabus/2nd-year";
...
export default function MockTest1Page() {
  ...
  return (
    <TestEngine
      ...
      subject="FULL MOCK"
      chapter="2nd year"
      title="MDCAT Mock Test 2 - 2nd Year Half Syllabus"
      timeLimit={180}
