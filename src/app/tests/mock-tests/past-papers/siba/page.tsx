...
const sibaPapers = [
  {
    ...
    title: "SIBA 2025",
    description:
      "Practice the complete SIBA 2025 past paper with authentic questions from Biology, Chemistry, Physics, English and Logical Reasoning.",
    href: "/tests/mock-tests/past-papers/siba/siba-25",
    button: "Start SIBA 2025",
    available: true,
    featured: true,
  },
  {
...
export default function SibaPastPapersPage() {
  return (
      ...
      <section className="container mx-auto px-4 pb-8 pt-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-[#cdd6e6] md:text-lg">
            Practice authentic SIBA past papers and experience the style,
