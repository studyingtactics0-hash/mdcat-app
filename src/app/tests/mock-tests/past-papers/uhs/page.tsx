...
const uhsPapers = [
  {
    ...
    title: "UHS 2025",
    description:
      "Practice the complete UHS 2025 past paper with authentic questions from Biology, Chemistry, Physics, English and Logical Reasoning.",
    href: "/tests/mock-tests/past-papers/uhs/uhs-25",
...
export default function UhsPastPapersPage() {
  return (
      ...
      <section className="container mx-auto px-4 pb-8 pt-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-[#cdd6e6] md:text-lg">
            Practice authentic UHS past papers and experience the style,
