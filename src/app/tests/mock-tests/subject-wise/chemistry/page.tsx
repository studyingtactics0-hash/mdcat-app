...
const tests = [
  {
    ...
    questions: 20,
    time: 20,
    description: "Practice important MDCAT Chemistry MCQs.",
  },
  {
    id: 2,
    ...
    questions: 45,
    time: 45,
    description: "Test your Chemistry concepts with another set of MCQs.",
  },
  {
    id: 3,
    ...
    questions: 90,
    time: 90,
    description: "Strengthen your Chemistry preparation with focused practice.",
  },
  {
    id: 4,
    ...
    questions: 135,
    time: 135,
    description: "Challenge yourself with another Chemistry mock test.",
  },
  {
    id: 5,
    ...
    questions: 180,
    time: 180,
    description: "Final Chemistry practice test covering important concepts.",
  },
];

export default function ChemistrySubjectWisePage() {
      ...
      <section className="container mx-auto px-4 pb-8 pt-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-[#cdd6e6] md:text-lg">
            Practice Chemistry with dedicated MDCAT-style mock tests.
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2">
          {tests.map((test) => (
            <button
              ...
              onClick={() =>
                router.push(
                  `/tests/mock-tests/subject-wise/chemistry/test-${test.id}`
                )
              }
      ...
      <section className="border-t border-[#172d4f]">
        <div className="container mx-auto px-4 py-10 text-center">
          <p className="text-sm text-[#8fa0b8]">
            Practice consistently. Master Chemistry. Improve your MDCAT score.
          </p>
