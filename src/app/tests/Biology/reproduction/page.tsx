  ...
  const tests = [
    {
      ...
      difficulty: "Basic",
      available: true,
      link: "/tests/Biology/reproduction/test-1",
    },
    {
      ...
      difficulty: "Moderate",
      available: true,
      link: "/tests/Biology/reproduction/test-2",
    },
    {
      ...
      difficulty: "MDCAT",
      available: true,
      link: "/tests/Biology/reproduction/test-3",
    },
    {
      ...
      difficulty: "MDCAT",
      available: true,
      link: "/tests/Biology/reproduction/test-4",
    },
    {
      ...
      difficulty: "MDCAT",
      available: true,
      link: "/tests/Biology/reproduction/test-5",
    },
  ];
