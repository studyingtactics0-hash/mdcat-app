...
export default function ImmunityPage() {
  const tests = [
    {
      title: "Immunity — Test 1",
      questions: 20,
      time: 20,
      difficulty: "DO YOU KNOW ANYTHING",
      link: "/tests/Biology/immunity/test-1",
    },
    {
      title: "Immunity — Test 2",
      questions: 35,
      time: 35,
      difficulty: "BASIC KNOWLEDGE TEST",
      link: "/tests/Biology/immunity/test-2",
    },
    {
      ...
      link: "/tests/Biology/immunity/test-3",
    },
    {
      title: "Immunity — Test 4",
      questions: 50,
      time: 50,
      difficulty: "ARE YOU READY FOR REAL MCQs",
      link: "/tests/Biology/immunity/test-4",
    },
    {
      ...
      link: "/tests/Biology/immunity/test-5",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto mt-12 space-y-5">
          {tests.map((test, index) => (
            ...
            >
              ...
              <Link
                href={test.link}
                className="bg-[#ff9800] hover:bg-[#e68900] text-white font-bold px-7 py-3 rounded-xl whitespace-nowrap text-center transition"
              >
                Start Test →
              </Link>
            </div>
