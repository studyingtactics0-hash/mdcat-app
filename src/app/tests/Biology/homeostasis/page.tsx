...
export default function HomeostasisPage() {
  ...
  const tests = [
    {
      title: "Homeostasis — Test 1",
      questions: 20,
      time: 20,
      difficulty: "Basic",
      link: "/tests/Biology/homeostasis/test-1",
    },
    {
      title: "Homeostasis — Test 2",
      questions: 35,
      time: 35,
      difficulty: "Moderate",
      link: "/tests/Biology/homeostasis/test-2",
    },
    {
      title: "Homeostasis — Test 3",
      questions: 50,
      time: 50,
      difficulty: "MDCAT",
      link: "/tests/Biology/homeostasis/test-3",
    },
    {
          ...
          {tests.map((test, index) => (
            ...
            >
              ...
              <button
                ...
                className="bg-[#ff9800] hover:bg-[#e38000] text-[#0b1e39] font-bold px-7 py-3 rounded-xl whitespace-nowrap transition"
              >
                Start Test →
              </button>
            </div>
