  ...
  const tests = [
    {
      ...
      time: 20,
      difficulty: "Basic",
      link: "/tests/Biology/bioenergetics/test-1",
    },
    {
      title: "Bioenergetics — Test 2",
      questions: 35,
      time: 35,
      difficulty: "Moderate",
      link: "/tests/Biology/bioenergetics/test-2",
    },
    {
      ...
      time: 50,
      difficulty: "MDCAT",
      link: "/tests/Biology/bioenergetics/test-3",
    },
    {
      title: "Bioenergetics — Test 4",
      questions: 50,
      time: 50,
      difficulty: "MDCAT",
      link: "/tests/Biology/bioenergetics/test-4",
    },
    {
      ...
      time: 50,
      difficulty: "MDCAT",
      link: "/tests/Biology/bioenergetics/test-5",
    },
  ];
