...
export default function EvolutionPage() {
  ...
  const tests = [
    {
      title: "Evolution — Test 1",
      questions: 20,
      time: 20,
      difficulty: "Basic",
      available: true,
      link: "/tests/Biology/evolution/test-1",
    },
    {
      ...
      difficulty: "Moderate",
      available: true,
      link: "/tests/Biology/evolution/test-2",
    },
    {
      ...
      difficulty: "MDCAT",
      available: true,
      link: "/tests/Biology/evolution/test-3",
    },
    {
      title: "Evolution — Test 4",
      questions: 50,
      time: 50,
      difficulty: "MDCAT",
      available: true,
      link: "/tests/Biology/evolution/test-4",
    },
    {
      ...
      difficulty: "MDCAT",
      available: true,
      link: "/tests/Biology/evolution/test-5",
    },
  ];
          ...
          {tests.map((test, index) => (
            ...
            >
              ...
              <button
                ...
                className={`font-bold px-7 py-3 rounded-xl whitespace-nowrap transition ${
                  test.available
                    ? "bg-[#ff9800] text-[#0b1e39] hover:bg-[#e38000] cursor-pointer"
