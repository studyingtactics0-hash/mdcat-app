export default function CirculationPage() {
  const tests = [
    {
      title: "Circulation — Test 1",
      questions: 20,
      time: 20,
      difficulty: "Basic",
      link: "/tests/Biology/circulation/test-1",
    },
    {
      ...
      time: 20,
      difficulty: "Basic",
      link: "/tests/Biology/circulation/test-2",
    },
    {
      ...
      time: 20,
      difficulty: "MDCAT",
      link: "/tests/Biology/circulation/test-3",
    },
    {
      ...
      time: 20,
      difficulty: "MDCAT",
      link: "/tests/Biology/circulation/test-4",
    },
    {
      ...
      time: 20,
      difficulty: "MDCAT",
      link: "/tests/Biology/circulation/test-5",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto mt-12 space-y-5">
          ...
          {tests.map((test, index) => (
            ...
            >
              ...
              <a
                href={test.link}
                className="bg-[#ff9800] hover:bg-[#e38000] text-[#0b1e39] font-bold px-7 py-3 rounded-xl whitespace-nowrap text-center transition"
              >
                Start Test →
              </a>
