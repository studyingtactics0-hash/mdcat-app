export default function EnglishPage() {
    const chapters = [
      {
        name: "Reading and Thinking Skill",
        tests: 5,
        icon: "📖",
        link: "/tests/English/reading-and-thinking-skill",
      },
      {
        name: "Formal and Writing Skill",
        tests: 5,
        icon: "✍️",
        link: "/tests/English/formal-and-writing-skill",
      },
    ];
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <p className="text-[#cdd6e6] max-w-2xl mx-auto mt-4">
              Select a chapter to practice English MCQs and improve your MDCAT
              preparation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto mt-10">
            <div className="bg-[#ff9800] text-[#0b1e39] rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-sm mt-2 font-medium">
                Practice individual English skills.
              </p>
            </div>
            ...
            <div className="bg-white text-[#0b1e39] rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-sm text-zinc-600 mt-2">
                Test yourself on the complete English syllabus.
              </p>
            </div>
            ...
            <div className="bg-white text-[#0b1e39] rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-sm text-zinc-600 mt-2">
                Attempt a timed MDCAT-style English mock.
              </p>
            </div>
          </div>
