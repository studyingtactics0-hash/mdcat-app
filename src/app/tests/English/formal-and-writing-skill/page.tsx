export default function FormalAndWritingSkillPage() {
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/English/formal-and-writing-skill/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/English/formal-and-writing-skill/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/English/formal-and-writing-skill/test-3",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/English/formal-and-writing-skill/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/English/formal-and-writing-skill/test-5",
      },
    ];
