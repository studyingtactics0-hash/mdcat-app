export default function ReadingAndThinkingSkillPage() {
    const tests = [
      {
        ...
        difficulty: "Basic",
        available: true,
        link: "/tests/English/reading-and-thinking-skill/test-1",
      },
      {
        ...
        difficulty: "Moderate",
        available: true,
        link: "/tests/English/reading-and-thinking-skill/test-2",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/English/reading-and-thinking-skill/test-3",
      },
      {
        title: "Reading and Thinking Skill — Test 4",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        available: true,
        link: "/tests/English/reading-and-thinking-skill/test-4",
      },
      {
        ...
        difficulty: "MDCAT",
        available: true,
        link: "/tests/English/reading-and-thinking-skill/test-5",
      },
    ];
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <p className="text-[#cdd6e6] max-w-2xl mx-auto mt-4">
              Choose a test and challenge yourself with MDCAT-style questions.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto mt-10 bg-[#142542] border border-[#243b60] rounded-2xl p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-[#cdd6e6]">
              ...
              <li>• You will be able to review your answers after submission.</li>
            </ul>
          </div>
        </section>
      </main>
