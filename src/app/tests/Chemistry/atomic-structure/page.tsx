export default function AtomicStructurePage() {
    const tests = [
      {
        title: "Atomic Structure — Test 1",
        questions: 20,
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/atomic-structure/test-1",
      },
      {
        ...
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/atomic-structure/test-2",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/atomic-structure/test-3",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/atomic-structure/test-4",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/atomic-structure/test-5",
      },
    ];
