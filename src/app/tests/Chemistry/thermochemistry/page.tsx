    ...
    const tests = [
      {
        ...
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/thermochemistry/test-1",
      },
      {
        ...
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/thermochemistry/test-2",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/thermochemistry/test-3",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/thermochemistry/test-4",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/thermochemistry/test-5",
      },
    ];
