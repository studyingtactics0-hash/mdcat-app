    ...
    const tests = [
      {
        ...
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/solids/test-1",
      },
      {
        title: "Solids — Test 2",
        questions: 35,
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/solids/test-2",
      },
      {
        title: "Solids — Test 3",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/solids/test-3",
      },
      {
        title: "Solids — Test 4",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/solids/test-4",
      },
      {
        title: "Solids — Test 5",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/solids/test-5",
      },
    ];
