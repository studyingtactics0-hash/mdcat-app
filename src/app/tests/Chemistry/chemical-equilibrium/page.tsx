export default function ChemicalEquilibriumPage() {
    const tests = [
      {
        title: "Chemical Equilibrium — Test 1",
        questions: 20,
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/chemical-equilibrium/test-1",
      },
      {
        ...
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/chemical-equilibrium/test-2",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/chemical-equilibrium/test-3",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/chemical-equilibrium/test-4",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/chemical-equilibrium/test-5",
      },
    ];
