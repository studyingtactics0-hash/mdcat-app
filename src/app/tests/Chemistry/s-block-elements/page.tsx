export default function SPBlockElementsPage() {
    const tests = [
      {
        title: "S and P Block Elements — Test 1",
        questions: 20,
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/s-and-p-block-elements/test-1",
      },
      {
        title: "S and P Block Elements — Test 2",
        questions: 35,
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/s-and-p-block-elements/test-2",
      },
      {
        title: "S and P Block Elements — Test 3",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/s-and-p-block-elements/test-3",
      },
      {
        title: "S and P Block Elements — Test 4",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/s-and-p-block-elements/test-4",
      },
      {
        title: "S and P Block Elements — Test 5",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/s-and-p-block-elements/test-5",
      },
    ];
