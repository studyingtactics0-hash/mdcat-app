    ...
    const tests = [
      {
        ...
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/transition-elements/test-1",
      },
      {
        ...
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/transition-elements/test-2",
      },
      {
        title: "Transition Elements — Test 3",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/transition-elements/test-3",
      },
      {
