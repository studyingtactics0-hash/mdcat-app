export default function FundamentalConceptsOfOrganicChemistryPage() {
    const tests = [
      {
        title: "Fundamental Concepts of Organic Chemistry — Test 1",
        questions: 20,
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/fundamental-concepts-of-organic-chemistry/test-1",
      },
      {
        title: "Fundamental Concepts of Organic Chemistry — Test 2",
        questions: 35,
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/fundamental-concepts-of-organic-chemistry/test-2",
      },
      {
        title: "Fundamental Concepts of Organic Chemistry — Test 3",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/fundamental-concepts-of-organic-chemistry/test-3",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/fundamental-concepts-of-organic-chemistry/test-4",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/fundamental-concepts-of-organic-chemistry/test-5",
      },
    ];
