    ...
    const tests = [
      {
        ...
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/fundamental-principles-of-organic-chemistry/test-1",
      },
      {
        ...
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/fundamental-principles-of-organic-chemistry/test-2",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/fundamental-principles-of-organic-chemistry/test-3",
      },
      {
