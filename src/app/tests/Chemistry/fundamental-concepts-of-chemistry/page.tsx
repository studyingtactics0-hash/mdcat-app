export default function FundamentalConceptsOfChemistryPage() {
    const tests = [
      {
        ...
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/fundamental-concepts-of-chemistry/test-1",
      },
      {
        ...
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/fundamental-concepts-of-chemistry/test-2",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/fundamental-concepts-of-chemistry/test-3",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/fundamental-concepts-of-chemistry/test-4",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/fundamental-concepts-of-chemistry/test-5",
      },
    ];
