    ...
    const tests = [
      {
        ...
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/reaction-kinetics/test-1",
      },
      {
        ...
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/reaction-kinetics/test-2",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/reaction-kinetics/test-3",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/reaction-kinetics/test-4",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/reaction-kinetics/test-5",
      },
    ];
