export default function AlcoholAndPhenolPage() {
    const tests = [
      {
        title: "Alcohol and Phenol — Test 1",
        questions: 20,
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/alcohol-and-phenol/test-1",
      },
      {
        ...
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/alcohol-and-phenol/test-2",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/alcohol-and-phenol/test-3",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/alcohol-and-phenol/test-4",
      },
      {
        ...
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/alcohol-and-phenol/test-5",
      },
    ];
