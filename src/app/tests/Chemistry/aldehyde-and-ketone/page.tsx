export default function AldehydeAndKetonePage() {
    const tests = [
      {
        ...
        time: 20,
        difficulty: "Basic",
        link: "/tests/Chemistry/aldehyde-and-ketone/test-1",
      },
      {
        ...
        time: 35,
        difficulty: "Moderate",
        link: "/tests/Chemistry/aldehyde-and-ketone/test-2",
      },
      {
        title: "Aldehyde and Ketone — Test 3",
        questions: 50,
        time: 50,
        difficulty: "MDCAT",
        link: "/tests/Chemistry/aldehyde-and-ketone/test-3",
      },
      {
